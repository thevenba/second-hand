 ...
 * VehicleModel Model
 *
 * @property \App\Model\Table\SecondHandTable|\Cake\ORM\Association\HasMany $SecondHand
 *
...
class VehicleModelTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('vehicle_model');
        $this->setDisplayField('name');
        $this->setPrimaryKey('id');

        $this->hasMany('SecondHand', [
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->integer('engine_size')
            ->requirePresence('engine_size', 'create')
            ->notEmpty('engine_size');
