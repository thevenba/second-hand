 ...
 * Picture Model
 *
 * @property \App\Model\Table\SecondHandTable|\Cake\ORM\Association\BelongsToMany $SecondHand
 *
...
class PictureTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('picture');
        $this->setDisplayField('id');
        $this->setPrimaryKey('id');

        $this->belongsToMany('SecondHand', [
            'foreignKey' => 'picture_id',
            'targetForeignKey' => 'second_hand_id',
